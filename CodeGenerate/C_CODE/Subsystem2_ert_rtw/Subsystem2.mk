###########################################################################
## Makefile generated for component 'Subsystem2'. 
## 
## Makefile     : Subsystem2.mk
## Generated on : Thu Mar 06 22:00:35 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Subsystem2.exe
...
COMPILER_COMMAND_FILE     = Subsystem2_comp.rsp
CMD_FILE                  = Subsystem2.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Subsystem2.exe
...
DEFINES_STANDARD = -DMODEL=Subsystem2 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/Subsystem2_ert_rtw/Subsystem2.c

MAIN_SRC = $(START_DIR)/Subsystem2_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/Subsystem2_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Subsystem2_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Subsystem2_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Subsystem2_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Subsystem2_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Subsystem2.obj : $(START_DIR)/Subsystem2_ert_rtw/Subsystem2.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.obj : $(START_DIR)/Subsystem2_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
