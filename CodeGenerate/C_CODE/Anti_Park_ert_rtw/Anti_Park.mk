###########################################################################
## Makefile generated for component 'Anti_Park'. 
## 
## Makefile     : Anti_Park.mk
## Generated on : Thu Mar 06 20:17:30 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Anti_Park.exe
...
COMPILER_COMMAND_FILE     = Anti_Park_comp.rsp
CMD_FILE                  = Anti_Park.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Anti_Park.exe
...
DEFINES_STANDARD = -DMODEL=Anti_Park -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/Anti_Park_ert_rtw/Anti_Park.c

MAIN_SRC = $(START_DIR)/Anti_Park_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/Anti_Park_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Anti_Park_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Anti_Park_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Anti_Park_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Anti_Park_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Anti_Park.obj : $(START_DIR)/Anti_Park_ert_rtw/Anti_Park.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.obj : $(START_DIR)/Anti_Park_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
