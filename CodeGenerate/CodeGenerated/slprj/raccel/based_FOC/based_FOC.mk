###########################################################################
## Makefile generated for component 'based_FOC'. 
## 
## Makefile     : based_FOC.mk
## Generated on : Thu Mar 20 15:05:25 2025
## Final product: ./based_FOC.exe
...
PRODUCT_NAME              = based_FOC
MAKEFILE                  = based_FOC.mk
MATLAB_ROOT               = D:/Program Files/MATLAB2024B
MATLAB_BIN                = D:/Program Files/MATLAB2024B/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = F:/work/MOTOR_Control/SENSORLESS/CodeGenerate/CodeGenerated
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = based_FOC_comp.rsp
CMD_FILE                  = based_FOC.rsp
...
DEFINES_STANDARD = -DMODEL=based_FOC -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/raccel/based_FOC/based_FOC.c $(START_DIR)/slprj/raccel/based_FOC/based_FOC_capi.c $(START_DIR)/slprj/raccel/based_FOC/based_FOC_data.c $(START_DIR)/slprj/raccel/based_FOC/based_FOC_tgtconn.c $(START_DIR)/slprj/raccel/based_FOC/rt_nonfinite.c $(START_DIR)/slprj/raccel/based_FOC/rt_zcfcn.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
...
OBJS = based_FOC.obj based_FOC_capi.obj based_FOC_data.obj based_FOC_tgtconn.obj rt_nonfinite.obj rt_zcfcn.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
%.obj : $(START_DIR)/slprj/raccel/based_FOC/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/based_FOC/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/based_FOC/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/based_FOC/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/based_FOC/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
based_FOC.obj : $(START_DIR)/slprj/raccel/based_FOC/based_FOC.c
	$(CC) $(CFLAGS) -o "$@" "$<"


based_FOC_capi.obj : $(START_DIR)/slprj/raccel/based_FOC/based_FOC_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


based_FOC_data.obj : $(START_DIR)/slprj/raccel/based_FOC/based_FOC_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


based_FOC_tgtconn.obj : $(START_DIR)/slprj/raccel/based_FOC/based_FOC_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/based_FOC/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_zcfcn.obj : $(START_DIR)/slprj/raccel/based_FOC/rt_zcfcn.c
	$(CC) $(CFLAGS) -o "$@" "$<"
