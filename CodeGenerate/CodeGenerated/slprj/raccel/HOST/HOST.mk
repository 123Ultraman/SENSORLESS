###########################################################################
## Makefile generated for component 'HOST'. 
## 
## Makefile     : HOST.mk
## Generated on : Thu Mar 13 14:53:07 2025
## Final product: ./HOST.exe
...
COMPILER_COMMAND_FILE     = HOST_comp.rsp
CMD_FILE                  = HOST.rsp
...
DEFINES_STANDARD = -DMODEL=HOST -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(MATLAB_ROOT)/toolbox/eml/externalDependency/timefun/coder_posix_time.c $(START_DIR)/slprj/raccel/HOST/HOST.c $(START_DIR)/slprj/raccel/HOST/HOST_capi.c $(START_DIR)/slprj/raccel/HOST/HOST_tgtconn.c $(START_DIR)/slprj/raccel/HOST/rtGetInf.c $(START_DIR)/slprj/raccel/HOST/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
...
OBJS = coder_posix_time.obj HOST.obj HOST_capi.obj HOST_tgtconn.obj rtGetInf.obj rt_nonfinite.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
LIBS = $(MATLAB_ROOT)/extern/lib/win64/mingw64/asynciocoder.lib
...
%.obj : $(START_DIR)/slprj/raccel/HOST/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/HOST/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/HOST/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/HOST/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/HOST/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
HOST.obj : $(START_DIR)/slprj/raccel/HOST/HOST.c
	$(CC) $(CFLAGS) -o "$@" "$<"


HOST_capi.obj : $(START_DIR)/slprj/raccel/HOST/HOST_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


HOST_tgtconn.obj : $(START_DIR)/slprj/raccel/HOST/HOST_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/slprj/raccel/HOST/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/HOST/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
