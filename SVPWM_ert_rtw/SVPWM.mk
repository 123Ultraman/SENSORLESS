...
## 
## Makefile     : SVPWM.mk
## Generated on : Thu Mar 06 18:28:26 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/SVPWM.exe
...
START_DIR                 = F:/work/MOTOR_Control/SENSORLESS
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = SVPWM_comp.rsp
CMD_FILE                  = SVPWM.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/SVPWM.exe
...
SRCS = $(START_DIR)/SVPWM_ert_rtw/SVPWM.c
...
%.obj : $(START_DIR)/SVPWM_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/SVPWM_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/SVPWM_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
